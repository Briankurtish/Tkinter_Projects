...
if __name__ == "__main__" :
	...
	enterTask = ttk.Label(gui, text = "Enter Your Task", )

	# create a text entry box 
	# for typing the task
	enterTaskField = ttk.Entry(gui, bootstyle="secondary")

	# create a Submit Button and place into the root window
	# when user press the button, the command or 
	# function affiliated to that button is executed 
	Submit = ttk.Button(gui, text = "Submit", bootstyle="success", command = insertTask, width=20)
	...
	taskNumber = ttk.Label(gui, text = "Delete Task Number",)
						
	taskNumberField = ttk.Text(gui, height = 1, width = 2, font = "lucida 13")

	# create a Delete Button and place into the root window
	# when user press the button, the command or 
	# function affiliated to that button is executed .
	delete = ttk.Button(gui, text = "Delete", bootstyle="warning", command = delete, width=20)

	# create a Exit Button and place into the root window
	# when user press the button, the command or 
	# function affiliated to that button is executed .
	Exit = ttk.Button(gui, text = "Exit", bootstyle="danger", command = exit, width=20)
