...
master.geometry("700x330")


# declaring objects for entering data
e1 = ttk.Entry(master, bootstyle="secondary")
e2 = ttk.Entry(master, bootstyle="secondary")
e3 = ttk.Entry(master, bootstyle="secondary")
e4 = ttk.Entry(master, bootstyle="secondary")
e5 = ttk.Entry(master, bootstyle="secondary")
e6 = ttk.Entry(master, bootstyle="secondary")
e7 = ttk.Entry(master, bootstyle="secondary")
...
def display():
	...
	if e4.get() == "A":
		...
		ttk.Label(master, text="40", bootstyle="info").grid(row=3, column=4)
		tot += 40

	# 9*number of subject credits give
	# total credits for grade B
	if e4.get() == "B":
		ttk.Label(master, text="36", bootstyle="info").grid(row=3, column=4)
		tot += 36

	# 8*number of subject credits give
	# total credits for grade C
	if e4.get() == "C":
		ttk.Label(master, text="32", bootstyle="info").grid(row=3, column=4)
		tot += 32

	# 7*number of subject credits
	# give total credits for grade D
	if e4.get() == "D":
		ttk.Label(master, text="28", bootstyle="warning").grid(row=3, column=4)
		tot += 28

	# 6*number of subject credits give
	# total credits for grade P
	if e4.get() == "P":
		ttk.Label(master, text="24", bootstyle="Warning").grid(row=3, column=4)
		tot += 24

	# 0*number of subject credits give
	# total credits for grade F
	if e4.get() == "F":
		ttk.Label(master, text="0", bootstyle="danger").grid(row=3, column=4)
		tot += 0

	# Similarly doing with other objects
	if e5.get() == "A":
		ttk.Label(master, text="40", bootstyle="info").grid(row=4, column=4)
		tot += 40
	if e5.get() == "B":
		ttk.Label(master, text="36", bootstyle="info").grid(row=4, column=4)
		tot += 36
	if e5.get() == "C":
		ttk.Label(master, text="32", bootstyle="info").grid(row=4, column=4)
		tot += 32
	if e5.get() == "D":
		ttk.Label(master, text="28", bootstyle="warning").grid(row=4, column=4)
		tot += 28
	if e5.get() == "P":
		ttk.Label(master, text="28", bootstyle="warning").grid(row=4, column=4)
		tot += 24
	if e5.get() == "F":
		ttk.Label(master, text="0", bootstyle="danger").grid(row=4, column=4)
		tot += 0

	if e6.get() == "A":
		ttk.Label(master, text="30", bootstyle="info").grid(row=5, column=4)
		tot += 30
	if e6.get() == "B":
		ttk.Label(master, text="27", bootstyle="info").grid(row=5, column=4)
		tot += 27
	if e6.get() == "C":
		ttk.Label(master, text="24", bootstyle="info").grid(row=5, column=4)
		tot += 24
	if e6.get() == "D":
		ttk.Label(master, text="21", bootstyle="warning").grid(row=5, column=4)
		tot += 21
	if e6.get() == "P":
		ttk.Label(master, text="28", bootstyle="warning").grid(row=5, column=4)
		tot += 24
	if e6.get() == "F":
		ttk.Label(master, text="0", bootstyle="danger").grid(row=5, column=4)
		tot += 0

	if e7.get() == "A":
		ttk.Label(master, text="40", bootstyle="info").grid(row=6, column=4)
		tot += 40
	if e7.get() == "B":
		ttk.Label(master, text="36", bootstyle="info").grid(row=6, column=4)
		tot += 36
	if e7.get() == "C":
		ttk.Label(master, text="32", bootstyle="info").grid(row=6, column=4)
		tot += 32
	if e7.get() == "D":
		ttk.Label(master, text="28", bootstyle="warning").grid(row=6, column=4)
		tot += 28
	if e7.get() == "P":
		ttk.Label(master, text="28", bootstyle="warning").grid(row=6, column=4)
		tot += 24
	if e7.get() == "F":
		ttk.Label(master, text="0", bootstyle="danger").grid(row=6, column=4)
		tot += 0

	# to display total credits
	ttk.Label(master, text=str(tot), bootstyle="success").grid(row=7, column=4)

	# to display SGPA
	ttk.Label(master, text=str(tot/15), bootstyle="success").grid(row=8, column=4)
...
e6.grid(row=5, column=2, pady=5)
e7.grid(row=6, column=2, pady=5)
...
button1 = ttk.Button(master, text="submit", command=display, bootstyle="success")
